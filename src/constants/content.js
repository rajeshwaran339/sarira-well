...
export function Hero() {
  ...
  useEffect(() => {
    if (isMounted) {
      ...
      const type = () => {
  // Local image placeholders - replace these paths with your actual local images
  logo: "sarira-logo.png",
  productMain: "sarira-fig-malt-product.jpg",
  productShowcase: "sarira-product-showcase.jpg", 
  productLifestyle: "sarira-lifestyle.jpg",
  traditionalKitchen: "traditional-kitchen.jpg",
  grandmothersHands: "grandmothers-hands.jpg",
  figTreeVideo: "fig-tree.mp4",
  // Additional product images for different sections
  productHero: "product-hero.jpg",
  productFeatures: "product-features.jpg",
  // Journal images
  journalFigs: "journal-figs.jpg",
  journalPostpartum: "journal-postpartum.jpg", 
  journalGutHealth: "journal-gut-health.jpg",
  // Recipe images
  recipeWarmDrink: "recipe-warm-drink.jpg",
  recipeSmoothie: "recipe-smoothie.jpg",
  recipeMuffins: "recipe-muffins.jpg",
  // Gallery images
  galleryWomanSmoothie: "gallery-woman-smoothie.jpg",
  galleryFigMaltSprinkle: "gallery-fig-malt-sprinkle.jpg",
  galleryMotherChild: "gallery-mother-child.jpg",
  galleryTraditionalKitchen: "gallery-traditional-kitchen.jpg",
  galleryIngredients: "gallery-ingredients.jpg",
  galleryLifestyle: "gallery-lifestyle.jpg"
    ...
    { src: "gallery-woman-smoothie.jpg", alt: "A woman enjoying a healthy smoothie bowl" },
    { src: "gallery-fig-malt-sprinkle.jpg", alt: "A close-up of SARIRA Fig Malt being sprinkled" },
    { src: "gallery-mother-child.jpg", alt: "A smiling mother feeding her child a healthy snack" },
    { src: "gallery-traditional-kitchen.jpg", alt: "Traditional Tamil kitchen setup" },
    { src: "gallery-ingredients.jpg", alt: "Organic figs, almonds and cashews" },
    { src: "gallery-lifestyle.jpg", alt: "SARIRA Fig Malt in daily life" }
